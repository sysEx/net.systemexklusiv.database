...
public class TestGettingSpecificPagesFromVolume extends TestCase {
...
//				    sb.append("\n");
			   ...
			   DBCollection wordColl = db.getCollection("word"); 
				...
				long wordOnAPageEnd =  (Long) selectedPageObj.get("obj_end");
				   ...
				   sb.append("this page starts @ word index: " + wordOnAPageStart);
				   sb.append("\n");
				   sb.append("this page ends @ word index: " + wordOnAPageEnd);
				   sb.append("\n");
				   
				// defining a "greater than or equals" start 
				BasicDBObject wordQuery = new BasicDBObject(
						"word_index", new BasicDBObject( "$gte", wordOnAPageStart )
				)// defining a "lower than or equals" end 
				.append("word_index", new BasicDBObject( "$lte", wordOnAPageEnd ));
